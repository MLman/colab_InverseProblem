...
class GaussianDiffusion:
    ...
    def ddim_sample_loop(
        ...
        final_sharp = final[0]["sample"]
        final_blur = final[1]["sample"]

        return final_sharp, final_blur
    ...
    def ddim_sample_loop_progressive(
        ...
        assert isinstance(shape, (tuple, list))
        if noise is not None:
            image_sharp, image_blur = noise[0], noise[1]
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                yield out_sharp, out_blur
                image_blur = out_blur["sample"]

                loss_sharp = get_loss(ori_sharp, out_sharp["pred_xstart"])
