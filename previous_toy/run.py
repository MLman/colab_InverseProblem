...
for sampler in args.sampler:
    ...
    script_list.append(f'python scripts/image_sample_cm_pretrained.py --log_dir {args.log_dir} --training_mode edm --generator determ-indiv --batch_size 16 --sigma_max 80 --sigma_min 0.002 --s_churn 0 --steps 40 --sampler {sampler} --model_path /hub_data1/sojin/cm_pretrained_weight/edm_bedroom256_ema.pt --attention_resolutions 32,16,8 --class_cond False --dropout 0.1 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --num_samples 500 --resblock_updown True --use_fp16 True --use_scale_shift_norm False --weight_schedule karras -log {log_name} --gpu {args.gpu} --use_wandb True')
    
    log_name = f'EDM:cat_sampler:{sampler}'
    script_list.append(f'python scripts/image_sample_cm_pretrained.py --log_dir {args.log_dir} --training_mode edm --generator determ-indiv --batch_size 16 --sigma_max 80 --sigma_min 0.002 --s_churn 0 --steps 40 --sampler {sampler} --model_path /hub_data1/sojin/cm_pretrained_weight/edm_cat256_ema.pt --attention_resolutions 32,16,8 --class_cond False --dropout 0.1 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --num_samples 500 --resblock_updown True --use_fp16 True --use_scale_shift_norm False --weight_schedule karras -log {log_name} --gpu {args.gpu} --use_wandb True')
    
    log_name = f'CD:bedroom_sampler:{sampler}'
    script_list.append(f'python scripts/image_sample_cm_pretrained.py --log_dir {args.log_dir} --batch_size 16 --generator determ-indiv --training_mode consistency_distillation --sampler {sampler} --model_path /hub_data1/sojin/cm_pretrained_weight/ct_bedroom256.pt --attention_resolutions 32,16,8 --class_cond False --use_scale_shift_norm False --dropout 0.0 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --num_samples 100 --resblock_updown True --use_fp16 True --weight_schedule uniform -log {log_name} --gpu {args.gpu} --use_wandb True')
            
    log_name = f'CD:bedroom_sampler:{sampler}'
    script_list.append(f'python scripts/image_sample_cm_pretrained.py --log_dir {args.log_dir} --batch_size 16 --training_mode consistency_distillation --sampler {sampler} --ts 0,17,39 --steps 40 --model_path /hub_data1/sojin/cm_pretrained_weight/cd_bedroom256_lpips.pt --attention_resolutions 32,16,8 --class_cond False --use_scale_shift_norm False --dropout 0.0 --image_size 256 --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --num_samples 500 --resblock_updown True --use_fp16 True --weight_schedule uniform -log {log_name} --gpu {args.gpu} --use_wandb True')
