...
# Training Command
# python consistency_deblur_models/scripts/edm_train.py --attention_resolutions 16,8 --class_cond False --dropout 0.1 --ema_rate 0.999,0.9999,0.9999432189950708 --global_batch_size 32 --image_size 256 --lr 0.0001 --num_channels 128 --num_res_blocks 2 --resblock_updown True --schedule_sampler lognormal --use_fp16 True --use_scale_shift_norm True --weight_decay 0.0 --weight_schedule karras --data_dir /app/input/dataset/afhq-cat/cat --gpu_num 0 --log_dir /app/outputs -log afhqCat_clean_edm
