...
# from cm.script_util_toy_afhq import (
# from cm.script_util_toy_lsuncat import ( # OK
from cm.script_util_edm_afhqcat import (
    NUM_CLASSES,
...
from cm.karras_diffusion_toy_ver1 import karras_sample
...
def main():
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        sample = karras_sample(
            ...
            sample_idx=cur_img_cnt,
            save_dir=save_dir,
            toy_exp=args.toy_exp,
...
def create_argparser():
    ...
    parser.add_argument('--toy_exp', type=str, default='forward_backward')
